...
public class GameButton extends JButton {
    private final Border hoverBorder = BorderFactory.createMatteBorder(0,0,10,0, SwingyConstants.Colors.BRIGHTEST);
    private final Border normalBorder = BorderFactory.createMatteBorder(0,0,3,0, SwingyConstants.Colors.BRIGHTERSHADE);
    private final Border selectedBorder = BorderFactory.createMatteBorder(0,0,10,0, SwingyConstants.Colors.REDDISH);
